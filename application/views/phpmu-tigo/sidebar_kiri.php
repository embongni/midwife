	...
	<?php
		...
		$album = $this->model_utama->view_where_ordering_limit('album',array('aktif' => 'Y'),'id_album','RANDOM',0,6);
		  ...
		  if ($hitung >= $col) {
			...
			$hitung++;
		  echo "<td><a href='".base_url()."albums/detail/$row[album_seo]'>
...
<div class="block">
	...
	<ul class="article-list">
		<?php 
			$kategori3 = $this->model_utama->view_join_two('berita','users','kategori','username','id_kategori',array('berita.id_kategori' => $rh['id_kategori'],'berita.status' => 'Y'),'id_berita','DESC',0,10);			
