<?php
    ...
    echo "<div class='col-md-6'>
        ...
        $feedlist = new rss('https://www.akbid-kbh.ac.id/kbh.xml'); /* Ubah link feed disini dengan link feed Anda */
        echo $feedlist->display(5,"Karya Bunda Husada"); /* Angka 7 digunakan untuk menampilkan jumlah artikel */
    echo "</section>";